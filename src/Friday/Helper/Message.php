...
use Countable;
use Friday\Contracts\Helper\Arrayable;
use Friday\Contracts\Helper\Message as MessageContract;

class Message implements Arrayable, Countable, MessageContract
{
    /**
    ...
    public function first($key = null, $format = null)
    {
        ...
        return is_array($firstMessage) ? $firstMessage[0] : $firstMessage;
    }
